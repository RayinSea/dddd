...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--data_dir', type=str, default="./data_rg",
                        help='Training data directory (env: TRAIN_DATA_PATH)')
    parser.add_argument('--schema_path', type=str, default="./data_rg/schema.json",
                        help='Schema JSON path (defaults to <data_dir>/schema.json)')
    parser.add_argument('--ckpt_dir', type=str, default="./outputs/ckpt",
                        help='Checkpoint output directory (env: TRAIN_CKPT_PATH)')
    parser.add_argument('--log_dir', type=str, default="./outputs/log",
    ...
    parser.add_argument('--buffer_batches', type=int, default=1,
    ...
    parser.add_argument('--seq_max_lens', type=str,
                        default='seq_a:64,seq_b:64,seq_c:64,seq_d:64',
    ...
    args.tf_events_dir = os.environ.get("TRAIN_TF_EVENTS_PATH", "./outputs/tensorboard")
